<nav class="navbar" role="navigation" aria-label="main navigation">
    ...
    <div class="navbar-brand">
        ...
        <img src="./img/image.png" width="80" height="100">
        </a>
    ...
    <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown">
                    ...
                    <a href="index.php?vista=product_category" class="navbar-item">Por Sub-Categoria</a>
                    <a href="index.php?vista=product_category" class="navbar-item">Por Status</a>
                    <a href="index.php?vista=product_search" class="navbar-item">Buscar</a>
                </div>
            </div>
            <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-end">
            <div class="navbar-item">
                <div class="buttons">
                    <a href="index.php?vista=user_update&user_id_up=<?php echo $_SESSION['id']; ?>" class="button is-small is-responsive">
                        Mi cuenta
                    </a>
